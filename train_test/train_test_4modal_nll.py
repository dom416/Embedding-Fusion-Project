...
from models.HFB_fusion_4modal import HFBSurv
...
def train(opt,train_data,test_data,device,k):
    ...
    random.seed(666)
    model = HFBSurv((1024, 1024, 1024,2048), (48, 48, 48, 48, 256), (20, 20, 10), (0.2, 0.2, 0.2, 0.2, 0.3), 20, 0.1)
    ...
    for epoch in tqdm(range(opt.epoch_count, opt.niter+opt.niter_decay+1)):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            pred = model(x_clin, x_pathr, x_unis, x_remedis)
